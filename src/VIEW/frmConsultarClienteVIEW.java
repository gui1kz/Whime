 ...
 */
public class frmConsultarClienteVIEW extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaCliente
     */
    public frmConsultarClienteVIEW() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tableClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "CPF", "Celular", "Genero", "Estado civil", "Endereço", "Nº", "CEP"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConsultarClienteVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmConsultarClienteVIEW().setVisible(true);
            }
        });
    }
